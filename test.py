...
Delta.setTL(3, 'orbitalRocketry1960', 48, 240, 270, 1, 0.105, 225, 150)
Delta.setTL(4, 'orbitalRocketry1961', 50, 215, 278, 4, 0.1194, 384, 300)
Delta.setTL(5, 'orbitalRocketry1964', 52, 100, 311, 4, 0.149, 475, None)
...
Kerolox.setTL(8, 'orbitalRocketry2004', 1400, 267, 304.8, 1, 1.48, 640, 300)
Kerolox.setTL(9, 'orbitalRocketry2009', 1600, 282, 311, 4, 0.89, 460, 350)
Kerolox.setTL(10,'orbitalRocketry2014', 1800, 288.5, 311, 4, 0.81, 400, 350)
